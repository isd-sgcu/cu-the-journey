export default {
  ...
  "28-0": {
    1: [
      "All of CU105s joined Chulalongkorn University",
      "the oldest university in Thailand founded by the royal institution,",
      "which claims to be the best in Thailand.",
      "It's being challenged and questioned as to why Thailand's education system is still horrible and inequal,",
      "when it's got the best faculties. Why did the university's executives support the PDRC ",
      "(People's Democratic Reform Committee) which destroyed Thailand's democracy,",
      "welcomed a prime minister that came from a coup",
      "and destroyed the communities around the university which came before.",
      "What will you do with these questions?",
      "Would you choose to do nothing?",
      "or would you choose to challenge them. Change them. Find the new values of Chula, ",
      "ones that would not leave anyone in the society behind.",
    ...
    3: [
      ...
      "enjoy your time, be healthy, both physically and mentally.",
    ...
    4: [
      ...
      "These changes can be hard for some people.",
      "I'll be rooting for you.",
      "However, this is not the only aspect of university life.",
      "There are great things about it too.",
      "More opportunities, larger society, more places we can learn from.",
      "Not just friends and teachers, but also the community, janitors, and even the security guards.",
      "More importantly, ",
      "being a student means you can be the voice that can help everyone here, no matter how big or small.",
      "",
    ...
    6: [
      "Yayyyy, welcome to Chula! I guess this is probably a new path for you all.",
      "Ignoring COVID, university has so many learning experiences to offer.",
      "Even with COVID,",
      "there are so many chances to learn, from a different kind of situation.",
    ...
    8: [
      ...
      " I hope you will get to do what matters to you and makes you happy, ",
      "meet a community that respects each other's freedom and rights, ",
    ...
    9: [
      ...
      "both inside and beyond the university. ",
    ...
    10: [
      ...
      "University is your next step in life, ",
      "and I would like to encourage you to live the life you want to live, ",
      "express your opinions with freedom,",
      "and become a great person who can help make a better society.",
      "Me as the 1st vice president and our team have done our best to organize this event as a present to you.",
